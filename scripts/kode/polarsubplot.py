...
#from DAG.src.pysymmetry.sunlight import terminator
...
class Polarsubplot(object):
    ...
    def plottrack(self, mlats, mlts, north, east, rotation = 0, SCALE = None, size = 10, unit = '', color = 'black', markercolor = 'black', marker = 'o', markersize = 20, **kwargs):
        """ like plotpins, only it's not a line pointing in the arrow direction but a prick at the tip of the arrow
